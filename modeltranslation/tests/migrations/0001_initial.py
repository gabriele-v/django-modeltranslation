    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "self_call_1",
                    models.ManyToManyField(to="tests.manytomanyfieldmodel"),
                ),
                (
                    "self_call_1_de",
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="m2m_untrans_ref", to="tests.nontranslated"
                    ),
                ),
                (
                    "untrans_de",
        ...
        migrations.CreateModel(
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(fields=("title", "sub_title"), name="unique_fields"),
                    models.UniqueConstraint(
                        fields=("title", "sub_title_de"),
                        name="unique_fields-sub_title_de",
                    ),
                    models.UniqueConstraint(
                        fields=("title", "sub_title_en"),
